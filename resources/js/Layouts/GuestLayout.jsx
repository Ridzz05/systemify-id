            ...
            <div className="relative z-10 mb-8 flex flex-col items-center gap-1">
                <Link href="/">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <span className="w-12 h-12 rounded-2xl bg-brand-lime flex items-center justify-center text-brand-dark font-black text-3xl shadow-lg border border-brand-lime/20">
                            S
                        </span>
