...
- **Apa yang dilakukan:**
  ...
  4. **Optimasi Side Rails:** Membatasi visibilitas elemen Side Rails vertikal agar hanya aktif pada layar monitor lebar `2xl` ke atas (`min-width: 1536px`), serta menurunkan tingkat opacity warnanya secara signifikan dari `0.2` menjadi `0.08` agar terasa sangat samar (subtle) dan tidak memecah fokus pembacaan konten utama.
